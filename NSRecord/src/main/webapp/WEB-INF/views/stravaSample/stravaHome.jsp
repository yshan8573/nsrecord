...
<head>
  ...
  <!-- strava css link -->
  <link href="<%= contextPath %>/strava/css/stravaCss.css" rel="stylesheet" type="text/css">
  <link href="<%= contextPath %>/strava/css/stravaCss1.css" rel="stylesheet" type="text/css">

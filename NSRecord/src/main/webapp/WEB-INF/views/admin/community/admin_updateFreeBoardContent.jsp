			...
			<section class="content container-fluid">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							<div class="box-body">
								<form action="<%=contextPath%>/adminCommunity/adminUpdateFreeBoardContentEnd" method="post">
								<input type="hidden" name="b_seq" value="${UpdateContent.b_seq}">
									...
									<div>
										<input type="radio" name="b_status" value="Y" checked>공개
										<input type="radio" name="b_status" value="N">비공개
									</div>
									<script>
										$(function () {

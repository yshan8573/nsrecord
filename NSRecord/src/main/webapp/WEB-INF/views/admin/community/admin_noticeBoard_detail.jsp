    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
              <!-- <i class="fa fa-exclamation"></i> --> ${notice.n_title }
              <small class="pull-right">Date: ${notice.n_date }</small>
            </h2>
          </div>
          <!-- /.col -->
        </div>
        ...
        <div class="row no-print">
          <div class="col-xs-12">
          	<button type="button" class="btn btn-danger pull-right" onclick="javascript:location.href='<%=contextPath%>/adminCommunity/adminNoticeBoardDelete?n_seq=${notice.n_seq }'">
				<i class="fa fa-trash"></i> 삭제하기
            </button>
            <button type="button" class="btn btn-success pull-right" style="margin-right: 5px;" onclick="javascript:location.href='<%=contextPath%>/adminCommunity/adminNoticeBoardUpdate?n_seq=${notice.n_seq }'">

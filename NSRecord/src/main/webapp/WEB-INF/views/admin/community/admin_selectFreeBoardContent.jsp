...
<script>
	...
	$(document).ready(function(){
		$("#updateFreeBoardContent").click(function(){
			var url = "<%=contextPath%>" + "/adminCommunity/adminUpdateFreeBoardContent";
	...
	function replyUpdateEnd(r_seq, r_content, b_seq){
		...
		location.href="<%=contextPath%>/adminCommunity/adminUpdateReplyEnd?r_seq=" + r_seq + "&r_content=" + value + "&b_seq=" + b_seq;
	}
	
	//댓글 삭제 기능
	function deleteReplyFn(r_seq, b_seq){
		location.href="<%=contextPath%>/adminCommunity/adminDeleteReply?r_seq=" + r_seq + "&b_seq=" + b_seq;
	}
